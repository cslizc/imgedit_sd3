    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                timestep = t.expand(scaled_latent_model_input.shape[0])
                ...
                # inference
                '''
                print("timestep", timestep.size())
                print("scaled_latent_model_input", scaled_latent_model_input.size())
                print("encoder_hidden_states", prompt_embeds.size())
                print("pooled_prompt_embeds", pooled_prompt_embeds.size())
                '''
